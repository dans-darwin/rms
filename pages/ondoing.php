...
<body>
	...
	$sql =  "SELECT * FROM keluhan WHERE status='On Doing'";
	$result = mysql_query($sql);
	        //pagination config start
        	$rpp = 2; // jumlah record per halaman
        	$reload = "ondoing.php?pagination=true";
        					...
        					<tbody>
        						...
        						while(($count<$rpp) && ($i<$tcount)) {
        							...
        							<tr>
        								...
        								<?php echo '<td><a href="edit.php?id='.$data['id_costumer'].'">Edit</a> | <a href="delete.php?id='.$data['id_costumer'].'" onclick="return confirm(\'Yakin?\')">Hapus</a></td>'; ?>
        							</tr>
        							<?php
        							$i++; 
        							$count++;
